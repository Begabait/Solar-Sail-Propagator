...
void fucked( double* state , double* deriv_state ){
...
void RHS_Function( double* state , double* deriv_state ){
    ...
    *( deriv_state + 2 ) = *( state + 5 );
    double norm = sqrt( pow( *( state ) , 2 ) + pow( *( state + 2 ) , 2 ) + pow( *( state + 3 ) , 2 ) );
    *( deriv_state + 3 ) = - *( state ) / ( pow( norm , 3 ) );
    *( deriv_state + 4 ) = - *( state + 1 ) / ( pow( norm , 3 ) );
    *( deriv_state + 5 ) = - *( state + 2 ) / ( pow( norm , 3 ) );
